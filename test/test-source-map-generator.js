...
exports["test .fromSourceMap with empty mappings and relative sources"] =
...
exports["test the two additional parameters of applySourceMap"] =
  async function (assert) {
...
exports["test github issue #72, check for duplicate names or sources"] =
  function (assert) {
    const map = new SourceMapGenerator({
      file: "test.js",
    });
...
exports["test applySourceMap with empty mappings and relative sources"] =
  async function (assert) {
