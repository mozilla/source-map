...
// async function wasm() {
//   function withMappingCallback(callback, f) {
//     try {
//       f();
//     } finally {
//       console.log('done callback', callback);
//     }
//   }

//   function parse_mappings(aStr) {
//     // Parse mapping into data structure(s).
//     const BASE_DIGITS = '';
//     for (let idx = 0; idx < aStr.length; ++idx) {
//       const code = aStr.charCodeAt(idx);
//       console.log({code});
//     }
//     console.log('parse_mappings', {aStr});
//     return new Uint8Array();
//   }

//   function free_mappings(ptr) {
//     console.log('free_mappings', {ptr});
//   }

//   function by_original_location() {}

//   function by_generated_location() {}
