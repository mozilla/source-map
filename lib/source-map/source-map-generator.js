...
define(function (require, exports, module) {
  ...
  function cmpLocation(loc1, loc2) {
    var cmp = loc1.line - loc2.line;
    return cmp ? cmp : loc1.column - loc2.column;
  }
    ...
    function SourceMapGenerator_serializeMappings() {
      ...
      for (var i = 0, len = this._mappings.length; i < len; i++) {
        ...
        if (mapping.generated.line !== previousGeneratedLine) {
          ...
          if (i > 0) {
            if (mapping.generated.column === previousGeneratedColumn &&
                mapping.original.line - 1 === previousOriginalLine &&
                mapping.original.column === previousOriginalColumn &&
                (!mapping.source ||
                  mapping.source === this._sources.at(previousSource)) &&
                (!mapping.name ||
                  mapping.name === this._names.at(previousName))) {
              continue;
            }
            result += ',';
          }
